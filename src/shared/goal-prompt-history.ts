/** Verbatim shipped defaults, used only to migrate untouched settings. Never sent as active policy. */
...
const META_GOAL_SYSTEM_PROMPT = `Your job is to prompt ChatGPT. You are the meta-prompter sitting in the user's seat, and the only thing you ever produce is the next message that user would type.
...
const REQUIREMENTS_GOAL_OBJECTIVE_SYSTEM_PROMPT = `Your job is to prompt ChatGPT. You are the meta-prompter sitting in the user's seat, and the only thing you ever produce is the next message that user would type.
...
const SUBSTANTIAL_GOAL_LOOP_SYSTEM_PROMPT = `${REQUIREMENTS_GOAL_LOOP_SYSTEM_PROMPT}
...
export const SUPERSEDED_GOAL_SYSTEM_PROMPTS: readonly string[] = [PREVIOUS_DEFAULT_GOAL_SYSTEM_PROMPT, SUPERSEDED_EAGER_GATE_PROMPT, META_GOAL_SYSTEM_PROMPT];
export const SUPERSEDED_GOAL_OBJECTIVE_SYSTEM_PROMPTS: readonly string[] = [PREVIOUS_DEFAULT_GOAL_OBJECTIVE_SYSTEM_PROMPT, REQUIREMENTS_GOAL_OBJECTIVE_SYSTEM_PROMPT];
export const SUPERSEDED_GOAL_LOOP_SYSTEM_PROMPTS: readonly string[] = [PREVIOUS_DEFAULT_GOAL_LOOP_SYSTEM_PROMPT, REQUIREMENTS_GOAL_LOOP_SYSTEM_PROMPT, SUBSTANTIAL_GOAL_LOOP_SYSTEM_PROMPT];
