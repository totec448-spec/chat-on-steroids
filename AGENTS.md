...
English, Spanish, Simplified Chinese, Traditional Chinese, Japanese, Turkish, French and Brazilian Portuguese (`pt-BR`)
use the existing UI catalogs (`i18n.ts`, `locales/{es,zh-CN,zh-TW,ja,tr,fr,pt-BR}.json`), with the selected locale in
