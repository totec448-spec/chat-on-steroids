...
English, Spanish, French, Simplified Chinese, Traditional Chinese and Japanese use the existing UI
catalogs (`i18n.ts`, `locales/{es,fr,zh-CN,zh-TW,ja}.json`), with the selected locale in
