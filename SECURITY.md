...
- The optional command allowlist limits which simple command invocation may start. It does not sandbox an allowed executable, its child processes, interactive stdin, build scripts or later filesystem/system effects.
